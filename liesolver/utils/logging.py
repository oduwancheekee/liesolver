...
def timing(f):
    """Decorator for measuring and printing the execution time of methods."""
...
class StreamToLogger(io.StringIO):
    ...
    def __init__(self, logger: logging.Logger, log_level: int = logging.INFO) -> None:
        ...
        Args:
            logger: The logger instance to write messages to.
    ...
    def flush(self) -> None:
        """Flush the stream. No-op for StreamToLogger."""
        pass
